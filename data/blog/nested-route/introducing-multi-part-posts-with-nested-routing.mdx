...
draft: false
summary: 'The articles template supports posts in nested sub-folders. This can be used to group posts of similar content e.g. a multi-part course. This post is itself an example of a nested route!'
---

# Nested Routes

The articles template supports posts in nested sub-folders. This helps in organisation and can be used to group posts of similar content e.g. a multi-part series. This post is itself an example of a nested route! It's located in the `/data/articles/nested-route` folder.
...
- More logical content organisation (articless will still be displayed based on the created date)
- Multi-part posts
